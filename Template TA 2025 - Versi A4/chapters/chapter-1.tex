...
\begin{enumerate}[noitemsep]
	...
	\item Bagaimana pengaruh variasi nilai parameter regularisasi (C) dan jenis kernel Support Vector Machine terhadap kinerja metode HOUM dalam menangani data klasifikasi tidak seimbang?
\end{enumerate}
...
\begin{enumerate}[noitemsep]
	...
	\item Menganalisis pengaruh variasi parameter regularisasi (C) dan jenis kernel Support Vector Machine terhadap kinerja metode HOUM dalam menangani data klasifikasi tidak seimbang.
\end{enumerate}
