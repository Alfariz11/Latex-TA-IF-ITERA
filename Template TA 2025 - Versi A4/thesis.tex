...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Pengaruh Variasi Oversampling dan Konfigurasi SVM Pada Metode HOUM Terhadap Data Klasifikasi Tidak Seimbang} % Judul Tugas Akhir dalam Bahasa Indonesia	
    % DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    \titleEN{The Effect of Oversampling Variations and SVM Configurations in the HOUM Method on Imbalanced Classification Data }      % Judul Tugas Akhir dalam Bahasa Inggris
